...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey('UserProfile', verbose_name="讲师",related_name='courserecord1')
    recorder = models.ForeignKey('UserProfile', verbose_name="记录者",related_name='courserecord2')
